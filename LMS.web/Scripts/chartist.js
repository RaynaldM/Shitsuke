(function (root, factory) {
    ...
    (function (window, document, Chartist) {
        ...
        Chartist.createSvg = function (container, width, height, className) {
            ...
            var svg = new Chartist.Svg('svg').attr({
                width: width,
                height: height
        ...
        Chartist.getDataArray = function (data, reverse, multi) {
            ...
            function recursiveConvert(value) {
                if (Chartist.isFalseyButZero(value)) {
                    ...
                    return undefined;
                } else if (((value.data || value) instanceof Array) || Array.isArray(value.data || value)) {
    ...
    (function (window, document, Chartist) {
        ...
        function extend(properties, superProtoOverride) {
            ...
            var constr = function () {
                ...
                var instance = this === Chartist ? Object.create(proto) : this;
        ...
        function animate(animations, guided, eventEmitter) {
            ...
            Object.keys(animations).forEach(function createAnimateForAttributes(attribute) {
                ...
                function createAnimate(animationDefinition, guided) {
                    ...
                    var animate = this.elem('animate', Chartist.extend({
