// Array Extension
Array.prototype.sumByValue = function (arrayToSum) {
    'use strict';
    if (this == null) {
        throw new TypeError("Array.prototype.sumByValue is null ou undefined");
    }
    if (arrayToSum == null) {
        throw new TypeError("Array to sum is null ou undefined");

    }
    var t = Object(this), len = t.length >>> 0, k = 0, value;
    if (arrayToSum.length !== len) {
        throw new TypeError("Arrays doesn't have the same length");
    }
